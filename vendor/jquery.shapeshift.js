  ...
  (function($, window, document) {
    ...
    Plugin = (function() {
      ...
      Plugin.prototype.createEvents = function() {
        ...
        $container.off("ss-removeItem").on("ss-removeItem", function(event, index) {
      ...
      Plugin.prototype.setGlobals = function() {
        ...
        // if (this.options.stampClass) {
        //   $('.' + this.options.stampClass).each(function(index, el){
      ...
      Plugin.prototype.setActiveChildren = function() {
        ...
        for (i = _i = 0; 0 <= total ? _i < total : _i > total; i = 0 <= total ? ++_i : --_i) {
          // @REFACTOR
          if (this.options.stampClass && $($children[i]).hasClass(this.options.stampClass)) {
            this.globals.stamps.push(i);
          }
      ...
      Plugin.prototype.setParsedChildren = function() {
        ...
        for (i = _i = 0; 0 <= total ? _i < total : _i > total; i = 0 <= total ? ++_i : --_i) {
          ...
          child = {
            ...
            x: parseInt($child.attr("data-position-x")),
            y: parseInt($child.attr("data-position-y"))
          };
      ...
      Plugin.prototype.getPositions = function(include_dragged) {
        ...
        savePosition = function(child) {
          var col, colspan, j, offset_x, offset_y, _j, _results, id, x, y;
          col = child.col;
          colspan = child.colspan;

          id = $(child.el).data('id');
          x = $(child.el).data('position-x');
          y = $(child.el).data('position-y');
      ...
      Plugin.prototype.getParsedPositions = function() {
        this.setParsedChildren();

        var _this = this, oldPositions = _this.getPositions(), newPositions = [], 
            children, firstChild, colWidth, colHeight;

        children = _this.$container.children();
        firstChild = $(children[0]);
        colWidth = this.globals.col_width || firstChild.width();
        colHeight = firstChild.height();

        for (var i = 0; i < oldPositions.length; i++) {
          var currentPosition = oldPositions[i]; 
      ...
      Plugin.prototype.enableDragNDrop = function() {
        ...
        if (options.enableDrag) {
          $container.children("." + active_class).filter('.' + options.dragWhitelistClass).draggable({
            addClasses: false,
            ...
            stop: function() {
              ...
              if ($original_container[0] === $current_container[0]) {
                $current_container.trigger("ss-rearranged", { selected: $selected, positions: _this.getParsedPositions() });
              } else {
                $original_container.trigger("ss-removed", { selected: $selected, positions: _this.getParsedPositions() });
                $current_container.trigger("ss-added", { selected: $selected, positions: _this.getParsedPositions() });
              }
      ...
      Plugin.prototype.setTargetPosition = function() {
        ...
        _this = this, options = _this.options, globals = _this.globals;
        if (!options.enableTrash) {
          ...
          if (total_positions > 1) {
            ...
            if (target_position === parsed_children.length) {
              ...
              if (globals.stamps && globals.stamps.includes(target_position -1)) {
                // @REFACTOR
                return;
              }
          ...
          // setTimeout(function(){
          //   // @REFACTOR
          //   if (!globals.stamps || !globals.stamps.length || !globals.stamps.includes(target_position -1)) {
          //     _this.arrange(true);
          //   }
          // }, 1000);
      ...
      Plugin.prototype.removeItem = function(index) {
        var _this = this, 
            child;

        $child = _this.$container.children().eq(index);
        $child.remove();

        setTimeout(function(){
          _this.$container.trigger("ss-removed", { selected: $child, positions: _this.getParsedPositions() });
        }, 500);
      }
    ...
    return $.fn[pluginName] = function(options) {
      return this.each(function() {
        ...
        return $.data(this, "plugin", new Plugin(this, options));
      });
    };
